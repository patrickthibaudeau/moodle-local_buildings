...
function display_page() {
    ...
    $pagetitle = get_string('faculty', 'local_buildings');
    $pageheading = get_string('viewing', 'local_buildings') . ' - ' . get_string('faculties', 'local_buildings');

    echo \local_buildings\Base::buildingsPage($CFG->wwwroot . '/local/buildings/admin/faculties.php', $pagetitle, $pageheading, $context);
            ...
            <div class='row'>
                <div class='col-md-12'>
                    <div id="nav_buttons">
                            ...
                            echo ' ' . \local_buildings\Action::getLink('create_faculty', 'faculty.php', 'btn btn-success', null, null, get_string('create', 'local_buildings'), 'fa fa-plus');
                            ?>
                        </div>
                    <div id="faculty_table_container">
                       <?php echo $FACULTIES->getHtmlTable();?>
                    </div>
                </div>
            </div>
