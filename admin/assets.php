...
function display_page() {
    ...
    $pagetitle = get_string('asset_header', 'local_buildings');
    $pageheading = get_string('viewing', 'local_buildings') . ' - ' . get_string('asset_header', 'local_buildings');

    echo \local_buildings\Base::buildingsPage('/admin/assets.php', $pagetitle, $pageheading, $context);
            ...
            <div class='row'>
                <div class='col-md-12'>
                    <div id="nav_buttons">
                            ...
                            echo ' ' . \local_buildings\Action::getLink('create_asset', 'asset.php', 'btn btn-success', null, null, get_string('create', 'local_buildings'), 'fa fa-plus');
                            ?>
                        </div>
                    <div id="asset_table_container" style="margin-top: 15px;">
                       <?php echo $ASSETS->getHtmlTable();?>
                    </div>
                </div>
            </div>
